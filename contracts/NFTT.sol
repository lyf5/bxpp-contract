...
contract NFTT is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        ERC721Upgradeable.__ERC721_init("Bai Xue Piao Piao Test6", "BXPPTEST6");
        setBaseURI("https://2kz9yd8ztj.execute-api.us-east-1.amazonaws.com/Prod/hello/");
    }
        ...
        returns (uint256)
    {
        ...
        TokenMeta memory meta = TokenMeta(newItemId, _price, _name, _image, _sale);
